      ...
      <div className="about-overlay">
        <div className="about-container">
          ...
          <p className="about-description">
            <strong>PROCESSTOOL</strong> is an Algerian company specializing in advanced tech solutions for process engineering calculations. As the first of its kind in Algeria, we pride ourselves on delivering innovative software products tailored to various industries.
          </p>
